...
def build_system_prompt():
    return (
        ...
        "---\n"
        "\n"
        "## SYSTEM CONTEXT (How the bot works)\n"
        "\n"
        "### Trading Hours\n"
        ...
        "\n"
        "### Automatic Safety (Code-Level)\n"
        "- **SL/TP Monitoring**: The code checks prices every **5 SECONDS**.\n"
        "- If price hits your sl_price → Auto SELL triggered (you don't need to monitor).\n"
        "- If price hits your tp_price → Auto SELL triggered (profit taken).\n"
        "- You just need to SET the sl_price and tp_price, the code handles execution.\n"
        "\n"
        "### Overnight Holding\n"
        "- Positions are KEPT overnight automatically (no forced close at 22h).\n"
        "- You can hold for multiple days until SL/TP hits or you decide to SELL.\n"
        "\n"
        "### Same-Day Protection\n"
        "- The code BLOCKS any SELL on the same day as BUY (PDT rule enforced by code).\n"
        "- If you try to SELL same-day, it will be blocked. Don't worry about it.\n"
        "\n"
        "---\n"
        "\n"
        "## DECISION PROCESS\n"
        ...
        "- If evidence is mixed, incomplete, stale, or weak = HOLD\n"
        ...
        "- **D+1 MINIMUM**: Code blocks same-day sells (PDT). You CAN sell starting D+1.\n"
        "- **BUT DON'T SELL SYSTEMATICALLY**: Just because you CAN sell at D+1 doesn't mean you SHOULD.\n"
        "- Only SELL if: (1) TP reached, (2) SL hit, (3) Major negative catalyst, (4) Better opportunity.\n"
        ...
        "| WHEN IN DOUBT | HOLD instead of forcing a trade. |\n"
        ...
        "  \"confidence\": 0.85,\n"
        "  \"reflection\": \"Synthèse courte en français: News → Signal → Risk\",\n"
        "  \"sl_price\": 95.50,\n"
        "  \"tp_price\": 110.00,\n"
...
def build_user_prompt(
    ...
    return (
        ...
        "If evidence is mixed, incomplete, stale, or low-confidence, return HOLD.\n"
